...
public class UserTest {
    ...
    public void getfollowingInterestsNext() {
        Data<List<Interests>> listData = pinterest.userOperations().getfollowingInterestsNext("https://api.pinterest.com/v1/me/following/interests/?cursor=Pz8wMDA5NmMzY2RjODc0OTMxNDExYmVmYTRhOWUwMDhjMnwxYjg1MDhhODdiMjVlY2M2OGQ1ZGMzZDI5NmJkOTQ3MTE4NDZkMzVlNzNmZGQ3ODliMDFiMjdhNWU5YTcxM2Vh&limit=3");
        System.out.println(listData);
        ;
    }
    ...
    public void getfollowingInterestsCursor() {
        Data<List<Interests>> listData = pinterest.userOperations().getfollowingInterestsCursor("Pz8wMDA5NmMzY2RjODc0OTMxNDExYmVmYTRhOWUwMDhjMnwxYjg1MDhhODdiMjVlY2M2OGQ1ZGMzZDI5NmJkOTQ3MTE4NDZkMzVlNzNmZGQ3ODliMDFiMjdhNWU5YTcxM2Vh", 3);
        System.out.println(listData);
    }
    ...
    public void getfollowingUsersNext() {
        Data<List<User>> listData = pinterest.userOperations().getfollowingUsersNext("https://api.pinterest.com/v1/me/following/users/?cursor=Pz9Nakl5TXpvMU1qSXdOalU1TVRreU1USTJOVEU0TXpJNk9USXlNek0zTURVNE5qVXdPVEF5TkRBM09GOUZ8OTQ1MmJmODk0MGUzMDE1MjJjYzA1OTQ4YmUwZTc2MTg3NjY1NDdmYzEzMmQ4ZDhkZDQxMzhhNDkwOGJhNWJlMA%3D%3D&fields=account_type%2Cbio%2Ccounts%2Ccreated_at%2Cfirst_name%2Cid%2Cimage%2Clast_name%2Curl%2Cusername&limit=2");
        System.out.println(listData);
    ...
    public void getfollowingUsersCursor() {
        Data<List<User>> listData = pinterest.userOperations().getfollowingUsersCursor("Pz9Nakl5TXpvMU1qSXdOalU1TVRreU1USTJOVEU0TXpJNk9USXlNek0zTURVNE5qVXdPVEF5TkRBM09GOUZ8OTQ1MmJmODk0MGUzMDE1MjJjYzA1OTQ4YmUwZTc2MTg3NjY1NDdmYzEzMmQ4ZDhkZDQxMzhhNDkwOGJhNWJlMA==", 2);
        System.out.println(listData);
    }
    ...
    public void getLikeNext(){
        final Data<List<Pins>> likeNext = pinterest.userOperations().getLikeNext("https://api.pinterest.com/v1/me/likes/?cursor=LT4yNzE0ODI2ODM3NjUxOTQ5Nzc6MTB8OGMwZDE1NzNmZWI0MmJmZGEyYzQzZjUzNWRlMGVjNzQxYTBlMzMxYzQ2NTNkMTE1ZThhYzdhZjU5NjczNTUwOA%3D%3D&fields=attribution%2Cboard%28counts%2Ccreated_at%2Ccreator%2Cdescription%2Cid%2Cimage%2Cname%2Cprivacy%2Creason%2Curl%29%2Ccolor%2Ccounts%2Ccreated_at%2Ccreator%2Cid%2Cimage%2Clink%2Cmedia%2Cmetadata%2Cnote%2Coriginal_link%2Curl&limit=10");
        System.out.println(likeNext);
    }

    @Test
    public void getLikeCursor(){
        final Data<List<Pins>> likeCursor = pinterest.userOperations().getLikeCursor("LT4yNzE0ODI2ODM3NjUxOTQ5Nzc6MTB8OGMwZDE1NzNmZWI0MmJmZGEyYzQzZjUzNWRlMGVjNzQxYTBlMzMxYzQ2NTNkMTE1ZThhYzdhZjU5NjczNTUwOA==",10);
