...
public class BoardsTemplate extends AbstractPinterestOperations implements BoardsOperations {
    ...
    @Override
    public Data<Boards> patch(String board, String name, String description) {
        return this.patch(board, name, description, DEFAULT_BOARDS_FIELDS);
    }

    @Override
    public Data<Boards> patch(String board, String name) {
        return this.patch(board, name, null);
    }
